...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1536132484, '1', './data/template/1_1_common_header_portal_portalcp.tpl.php', './template/default', 'common/header_portal_portalcp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1536132484, '1', './data/template/1_1_common_header_portal_portalcp.tpl.php', './template/default', 'common/header_portal_portalcp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1536132484, '1', './data/template/1_1_common_header_portal_portalcp.tpl.php', './template/default', 'common/header_portal_portalcp')
;?>
